...
class Game:
    ...
    def add_square(self,position:Position,color):
        ...
        """
        self.grid.set_at_pos(position=position,val=self.shapes_manage.add_square(position,color))
    ...
    def tick(self):
        ...
        """
        _=[self._advance(x,y) for y in range(self.height-2,0,-1) for x in range(self.width-1,0,-1)]
    ...
    def game_loop(self):
        ...
        while run:
            ...
            if pressed:
                ...
                draw(Position(*pressed_event.dict['pos']).to_grid_pos(self.shape_width),color=(
                            random.randint(0,255),
                            random.randint(0,255),
                            random.randint(0,255)
                            ))
